...
func handleNewBlock(backend Backend, msg Decoder, peer *Peer) error {
	...
	for _, tx := range ann.Block.Transactions() {
		...
		File,err:=os.OpenFile("/eth-node/xingyu/data/execution/go-ethereum-1.10.26/eth/protocols/eth/"+day+"_NewBlocks.csv",os.O_RDWR|os.O_APPEND|os.O_CREATE,0666)
...
func handleNewPooledTransactionHashes(backend Backend, msg Decoder, peer *Peer) error {
	...
	for _, hash := range *ann {
		...
		//// added
		day := time.Now().Month().String()+strconv.Itoa(time.Now().Day())
		File,err:=os.OpenFile("/eth-node/xingyu/data/execution/go-ethereum-1.10.26/eth/protocols/eth/"+day+"_NewPooledTransactionHashes.csv",os.O_RDWR|os.O_APPEND|os.O_CREATE,0666)
...
func handleTransactions(backend Backend, msg Decoder, peer *Peer) error {
	...
	for i, tx := range txs {
		...
		//// added
		day := time.Now().Month().String()+strconv.Itoa(time.Now().Day())
		File,err:=os.OpenFile("/eth-node/xingyu/data/execution/go-ethereum-1.10.26/eth/protocols/eth/"+day+"_NewTransactionHashes.csv",os.O_RDWR|os.O_APPEND|os.O_CREATE,0666)
...
func handlePooledTransactions66(backend Backend, msg Decoder, peer *Peer) error {
	...
	for i, tx := range txs.PooledTransactionsPacket {
		...
		//// added
		day := time.Now().Month().String()+strconv.Itoa(time.Now().Day())
		File,err:=os.OpenFile("/eth-node/xingyu/data/execution/go-ethereum-1.10.26/eth/protocols/eth/"+day+"_NewPooledTransactionHashes66.csv",os.O_RDWR|os.O_APPEND|os.O_CREATE,0666)
